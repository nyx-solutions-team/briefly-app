...
export function TipTapBubbleMenu({ editor, onRequestLinkEdit }: { editor: Editor; onRequestLinkEdit: LinkEditorRequest }) {
...
export function TipTapToolbar({
  ...
  editor: Editor | null;
  onRequestLinkEdit: LinkEditorRequest;
}) {
  ...
  return (
    <div className="space-y-2">
      <div className="flex flex-wrap items-center gap-1">
        ...
        <ToolbarButton label="Link" shortcut="Ctrl/Cmd+K" active={editor.isActive("link")} onClick={onRequestLinkEdit}>
          <LinkIcon className="h-4 w-4" />
        </ToolbarButton>
