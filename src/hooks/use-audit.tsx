...
export function useAudit() {
    ...
    const [actorsOrgId, setActorsOrgId] = useState<string | null>(null);
    ...
    const loadActors = useCallback(async () => {
        try {
            ...
            if (actorsLoaded && actorsOrgId === orgId) return;
    ...
    }, [actorsLoaded, actorsLoading, actorsOrgId]);
