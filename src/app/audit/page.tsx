...
export default function AuditPage() {
  ...
  const { user, bootstrapData, hasPermission, isLoading: authLoading } = useAuth();
  ...
  useEffect(() => {
    ...
    if (
      ...
      Object.prototype.hasOwnProperty.call(bootstrapData.permissions, "pages.activity")
    ) {
      setCanViewAudit(hasPermission("pages.activity"));
      setCheckingAccess(false);
      return;
    }
  ...
  }, [authLoading, bootstrapData, hasPermission, user]);

  const ensureActorsLoaded = useCallback(() => {
    if (canViewAudit && !actorsLoaded && !actorsLoading) {
      void loadActors();
    }
  }, [actorsLoaded, actorsLoading, canViewAudit, loadActors]);
  ...
  useEffect(() => {
    if (mobileFilterOpen && mobileFilterView === "actors") {
      ensureActorsLoaded();
    }
  }, [ensureActorsLoaded, mobileFilterOpen, mobileFilterView]);
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-3">
            ...
            <div className="hidden md:flex items-center gap-2">
              ...
              <Popover
                ...
                onOpenChange={(open) => {
                  setPeopleFilterOpen(open);
                  if (open) ensureActorsLoaded();
                }}
              >
