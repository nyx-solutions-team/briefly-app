...
const SETTINGS_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/settings/document-assets', label: 'Business Profile', Icon: Package2, permission: 'org.update_settings', description: 'Manage company profiles, letterheads, banking, and products' },
      { href: '/settings/approval-templates', label: 'Approval Flows', Icon: ShieldCheck, permission: 'org.update_settings', description: 'Build multi-stage review flows' },
      { href: '/settings/templates', label: 'Document Templates', Icon: FileText, permission: 'org.update_settings', description: 'Design reusable document layouts and fields' },
